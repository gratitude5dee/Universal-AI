...
export default function Index() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-futuristic-baseDarker to-futuristic-accent/10 p-4 text-white"
    >
      <div className="max-w-md w-full space-y-8 glass-card p-8 rounded-xl border border-white/10">
